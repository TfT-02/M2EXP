		...
		if(cmd.getName().equalsIgnoreCase("brepair")) {
			...
			if (sender instanceof Player) {
				...
				if (args[0].equals("info")){
						...
						player.sendMessage("Price for 5 Units is: "+ " and gives you: "+ " Exp of Repair");
						player.sendMessage("Price for 10 Units is: "+ " and gives you: "+ " Exp of Repair");
						player.sendMessage("Price for 20 Units is: "+ " and gives you: "+ " Exp of Repair");
						player.sendMessage("Price for 50 Units is: "+ " and gives you: "+ " Exp of Repair");
						player.sendMessage("Price for 100 Units is: "+ " and gives you: "+ " Exp of Repair");
						player.sendMessage("Price for 200 Units is: " + " and gives you: "+ " Exp of Repair");
						player.sendMessage("Price for 300 Units is: "+ " and gives you: "+ " Exp of Repair");
						player.sendMessage("Do /brepair and the number of units IE: /brepair 20");
								...
								EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p5);
									...
									if(r.transactionSuccess()) {
											...
											ExperienceAPI.addRawXP(player, SkillType.REPAIR, plugin.u5);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p10);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.REPAIR, plugin.u10);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p20);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.REPAIR, plugin.u20);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p50);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.REPAIR, plugin.u50);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p100);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.REPAIR, plugin.u100);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p200);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.REPAIR, plugin.u200);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p300);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.REPAIR, plugin.u300);
