				...
				if (sender instanceof Player) {
					...
					if (args[0].equals("info")) {
						...
						player.sendMessage("Price for 5 Units is: "
								+ " and gives you: " + " Exp of Excavation");
						...
						if (r.transactionSuccess()) {
							...
							ExperienceAPI.addRawXP(player,
									SkillType.EXCAVATION, plugin.u5);
						...
						if (r.transactionSuccess()) {
							sender.sendMessage(String
									.format("You were given %s units of exp and now have %s",
											...
											M2EXP.economy.format(r.balance)));
							ExperienceAPI.addRawXP(player,
									SkillType.EXCAVATION, plugin.u10);
						...
						if (r.transactionSuccess()) {
							sender.sendMessage(String
									.format("You were given %s units of exp and now have %s",
											...
											M2EXP.economy.format(r.balance)));
							ExperienceAPI.addRawXP(player,
									SkillType.EXCAVATION, plugin.u20);
						...
						if (r.transactionSuccess()) {
							sender.sendMessage(String
									.format("You were given %s units of exp and now have %s",
											...
											M2EXP.economy.format(r.balance)));
							ExperienceAPI.addRawXP(player,
									SkillType.EXCAVATION, plugin.u50);
						...
						if (r.transactionSuccess()) {
							sender.sendMessage(String
									.format("You were given %s units of exp and now have %s",
											...
											M2EXP.economy.format(r.balance)));
							ExperienceAPI.addRawXP(player,
									SkillType.EXCAVATION, plugin.u100);
						...
						if (r.transactionSuccess()) {
							sender.sendMessage(String
									.format("You were given %s units of exp and now have %s",
											...
											M2EXP.economy.format(r.balance)));
							ExperienceAPI.addRawXP(player,
									SkillType.EXCAVATION, plugin.u200);
						...
						if (r.transactionSuccess()) {
							sender.sendMessage(String
									.format("You were given %s units of exp and now have %s",
											...
											M2EXP.economy.format(r.balance)));
							ExperienceAPI.addRawXP(player,
									SkillType.EXCAVATION, plugin.u300);
