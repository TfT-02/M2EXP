...
public class Buyswords implements CommandExecutor{
	private M2EXP plugin;

	
	
	public Buyswords(M2EXP plugin) {
		this.plugin = plugin;
	}
		...
		if(cmd.getName().equalsIgnoreCase("bswords")) {
			...
			if (sender instanceof Player) {
				...
				if (args[0].equals("info")){
						player.sendMessage("Buy Swords EXP");
						player.sendMessage("Price for 5 Units is: "+ " and gives you: "+ " Exp of Swords");
						player.sendMessage("Price for 10 Units is: "+ " and gives you: "+ " Exp of Swords");
						player.sendMessage("Price for 20 Units is: "+ " and gives you: "+ " Exp of Swords");
						player.sendMessage("Price for 50 Units is: "+ " and gives you: "+ " Exp of Swords");
						player.sendMessage("Price for 100 Units is: "+ " and gives you: "+ " Exp of Swords");
						player.sendMessage("Price for 200 Units is: " + " and gives you: "+ " Exp of Swords");
						player.sendMessage("Price for 300 Units is: "+ " and gives you: "+ " Exp of Swords");
						player.sendMessage("Do /bswords and the number of units IE: /bswords 20");
				}
								...
								EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p5);
									...
									if(r.transactionSuccess()) {
											...
											ExperienceAPI.addRawXP(player, SkillType.SWORDS, plugin.u5);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p10);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.SWORDS, plugin.u10);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p20);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.SWORDS, plugin.u20);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p50);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.SWORDS, plugin.u50);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p100);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.SWORDS, plugin.u100);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p200);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.SWORDS, plugin.u200);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p300);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.SWORDS, plugin.u300);
