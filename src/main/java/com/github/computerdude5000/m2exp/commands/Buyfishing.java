...
public class Buyfishing implements CommandExecutor{
	...
	public Buyfishing(M2EXP plugin) {
		this.plugin = plugin;
	}
	
	public boolean onCommand(CommandSender sender, Command cmd, String commandLabel, String[] args) {
		try{
		if(cmd.getName().equalsIgnoreCase("bfishing")) {
		
			if (sender instanceof Player) {
				Player player = (Player) sender;
				if (args[0].equals("info")){
						player.sendMessage("Buy Fishing EXP");
						player.sendMessage("Price for 5 Units is: "+ " and gives you: "+ " Exp of Fishing");
						player.sendMessage("Price for 10 Units is: "+ " and gives you: "+ " Exp of Fishing");
						player.sendMessage("Price for 20 Units is: "+ " and gives you: "+ " Exp of Fishing");
						player.sendMessage("Price for 50 Units is: "+ " and gives you: "+ " Exp of Fishing");
						player.sendMessage("Price for 100 Units is: "+ " and gives you: "+ " Exp of Fishing");
						player.sendMessage("Price for 200 Units is: " + " and gives you: "+ " Exp of Fishing");
						player.sendMessage("Price for 300 Units is: "+ " and gives you: "+ " Exp of Fishing");
						player.sendMessage("Do /bfishing and the number of units IE: /bfishing 20");
				}
								...
								EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p5);
									...
									if(r.transactionSuccess()) {
											...
											ExperienceAPI.addRawXP(player, SkillType.FISHING, plugin.u5);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p10);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.FISHING, plugin.u10);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p20);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.FISHING, plugin.u20);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p50);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.FISHING, plugin.u50);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p100);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.FISHING, plugin.u100);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p200);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.FISHING, plugin.u200);
							...
							EconomyResponse r = M2EXP.economy.withdrawPlayer(player.getName(), plugin.p300);
								...
								if(r.transactionSuccess()) {
										...
										ExperienceAPI.addRawXP(player, SkillType.FISHING, plugin.u300);
